...
public:
    ...
    void setupUi(QMainWindow *WenceslasII)
    {
        ...
        regTable->setSelectionMode(QAbstractItemView::ExtendedSelection);
        ...
        timeTable->setSelectionMode(QAbstractItemView::ExtendedSelection);
        timeTable->setSelectionBehavior(QAbstractItemView::SelectRows);
        timeTable->setShowGrid(false);

        horizontalLayout_4->addWidget(timeTable);
        ...
        evalCategoryCombo = new QComboBox(evaluate);
        evalCategoryCombo->setObjectName(QString::fromUtf8("evalCategoryCombo"));

        horizontalLayout_9->addWidget(evalCategoryCombo);
